...
# Run the menu option for the store
    while True:
        print("""
        *************************************************
        1. Available number of cars in store
        2. Rent a Car on hourly basis for $35/hr
        3. Rent a Car on daily basis for $280/day
        4. Rent a Car on weekly basis for $1400/week
        5. Return a rented Car back.
        6. Exit
        *************************************************
        """)
        # Get an input from user for his choice
        choice = int(input("\nHow would you like to use our Car Rental services\n"))
